...
window.onload = function () {
    let img = document.getElementsByClassName('star')
    ...
    function clicked(i, img) {
        ...
        console.log(i)
        for(let j = 0; j < i + 1; j++){
            $(img[j]).children('path').attr('d', 'M10.2637 15.749L4.07617 19.499L5.7168 12.4678L0.279297 7.7334L7.45117 7.12402L10.2637 0.514648L13.0762 7.12402L20.248 7.7334L14.8105 12.4678L16.4512 19.499L10.2637 15.749Z" fill="url(#paint0_linear)');
            console.log('s12s')
        }
        for(let j = 4; j > i; j--){
