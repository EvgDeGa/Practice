...
export function guest() {
    ...
    let minus = document.getElementsByClassName("guest_minus")
    let plus = document.getElementsByClassName("guest_plus")
    let number = document.getElementsByClassName("guest_number")
    ...
    guest.addEventListener("click", () => clicked(), false)
